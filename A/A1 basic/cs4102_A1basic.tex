...
\begin{proof}
    ...
    \noindent Then,
    \begin{align}
        xy \hspace{0.2cm} &= \hspace{0.2cm} (2^b-1)(1+2^b+...+2^{(a-1)b}) \\
           \hspace{0.2cm} &= \hspace{0.2cm} 2^b(1+2^b+...+2^{(a-1)b})-(1+2^b+...+2^{(a-1)b}) \\
           \hspace{0.2cm} &= \hspace{0.2cm} 2^{ab}-1 \\
           \label{eq5}
        \hspace{0.2cm} &= \hspace{0.2cm} 2^n-1.
    \end{align}
...
\begin{quote}
    It takes a great deal of bravery to stand up to our enemies, but just as much to stand up to our friends.\cite{Rowling}
\end{quote}
